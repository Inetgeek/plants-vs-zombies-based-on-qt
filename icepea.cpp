...
IcePea::IcePea(QWidget* parent):Plant(parent){
    ...
    //动画设置
    plantSwingMovie = new QMovie(":/images/SnowPea.gif");
    ...
    QObject::connect(shootingTriggerTimer, &QTimer::timeout, this, &IcePea::slot_shootingBullet);//每1.4秒发射一个子弹
}

void IcePea::slot_shootingBullet(){
